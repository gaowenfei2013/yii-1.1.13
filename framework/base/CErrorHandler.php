...
class CErrorHandler extends CApplicationComponent
{
	...
	{
		// 你会以为这里只是执行一个控制器动作，那么错误信息是如何传递的
		// 其实在动作内，通过 Yii::app()->errorHandler->error 获取到的错误信息，然后再传给视图
