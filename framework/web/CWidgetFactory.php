...
class CWidgetFactory extends CApplicationComponent implements IWidgetFactory
{
	 ...
	 */
	// 部件初始属性，数组，例子看上面
	// 注意，这里定义的属性可能被CBaseController::createWidget调用是设置的属性给覆盖掉。
	 ...
	 * @since 1.1.3
	 */
	// 因为具有皮肤的部件有性能影响，你可能只希望某些部件可以拥有皮肤功能。
	// 所有不在此列表中的部件都不能使用皮肤。默认null，表示搜有部件都可以拥有皮肤功能。
	...
	public function init()
	{
		...
		// 如果开启皮肤功能，并且未设置文件路径，则使用应用视图目录下的skins目录
