...
/**
 * This is the model class for table "tbl_oauth2".
 *
 * The followings are the available columns in table 'tbl_oauth2':
 * @property string $id
 * @property string $uid
...
class Oauth2 extends CActiveRecord
{
	 ...
	 * @return Oauth2 the static model class
	 */
	...
	{
		return Oauth2Module::g('oauth2Table');
	}
