...
class EConfig extends CApplicationComponent
{
	...
	{
		$db->createCommand("CREATE TABLE `{$this->configTableName}`( `key` VARCHAR(100) NOT NULL COMMENT '键名', `value` TEXT NOT NULL COMMENT '键值', PRIMARY KEY (`key`) ) ENGINE=INNODB CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='配置表';")->execute();
	}
